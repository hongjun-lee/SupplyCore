# Sprint 13a 任务卡 V0.2（cici 锁版）

**项目：** 阜矿物资供应管理系统 / SupplyCore
**版本：** V0.2（cici 锁版 · 2026-05-14）
**日期：** 2026-05-14
**文档性质：** 实施层 · Sprint 13a 锁版任务卡
**配套：** [`Sprint-12a-Demo-脚本-V0.1.md`](./Sprint-12a-Demo-脚本-V0.1.md) §五 候选范围

---

## 一、Sprint 13a 锁版方向（cici V0.2 锁版决策点 1：A + C 双轨）
...
|---|---|---|---|---|
| 1 | Sprint 13a 主线方向（A / B / C） | A + C 双轨 | ✅ **A 权限审批 + C R-09 看板（双轨）** | B NC 接口顺延 Sprint 14a 集中突破 |
| 2 | 累计技术债哪些必修 | P2-1 + P2-8 | ✅ **4 项全修**：P2-1 + P2-8 + UTC backfill + cross-org 审计 | 工时 +1.8 PD（vs V0.1 1.0 PD），转入 §二 必修 |
| 3 | 工时预算 | 10-12 PD | ✅ **12-15 PD（激进）** | A 6 + C 4 + 技术债 1.8 + Codex 0.5 + 缓冲 ~2 = 14.3 PD 落区间内 |
| 4 | 子代理并行策略 | 主 + b/c | ✅ **主代理 a + 子代理 b + 子代理 c**（sweet spot 3.8x） | a 做 A 主线 / b 做 C 顺延 / c 做累计技术债 4 项 |
| 5 | Codex 12a 评审时机 | Sprint 12a 收尾后触发 | ✅ **已完成**（13/13 commits 评审 + 修复落地 a8e7b19）| Sprint 13a §七 附录已含 finding 累计 |
...
| V0.2 | 2026-05-14 | **cici 锁版** — 5 决策点全锁：①A+C 双轨（B NC 顺延 14a）②4 项累计技术债全修（P2-1 + P2-8 + UTC backfill + cross-org 审计）③12-15 PD 激进预算 ④主+2 子代理 sweet spot 3.8x ⑤Codex 12a 评审已完成 |
