# Sprint 18b 任务卡 V0.2（锁版）

**项目：** 阜矿物资供应管理系统 / SupplyCore
**版本：** V0.2（锁版 · cici 2026-05-14 评审锁定主线 A2）
**日期：** 2026-05-14
**文档性质：** 实施层 · Sprint 18b 锁版任务卡
**配套：** [`Sprint-18a-Demo-脚本-V0.1.md`](./Sprint-18a-Demo-脚本-V0.1.md) §四 候选范围、[`Sprint-18a-NC端配合度评估-V0.1.md`](./Sprint-18a-NC端配合度评估-V0.1.md)、Sprint-18b-V0.1（已锁定）

---

## 一、Sprint 18b 主线方向（锁版 · 决策点 1）
...
| # | 决策点 | V0.2 锁版结论 |
|---|---|---|
| 1 | Sprint 18b 主线方向 | **A2 NC 真端点 phase 2（关键依赖 NC 端配合 18a 评估已交付）** |
| 2 | 6 累计技术债哪些必修 | **全修** ~2-3 PD（A2-3 主线吸收 #1 / A2-5 主线吸收 #3-#6 即 Codex 18a 4 P3） |
| 3 | 工时预算 | **7-8 PD**（A2 5 + 技术债 2-3 + 缓冲）|
| 4 | 子代理并行策略 | **主+2 子代理 sweet spot 3.8x**（A2-5 主代理 a + A2-3 主代理 a + A2-1/A2-2/A2-4 等 NC 端反馈）|
| 5 | Codex 18a 评审 | 已完成 0 P1 + 0 P2 全顺延 P3（commit 仅 §六附录）连续 7 Sprint 0 顺延 P2 |
| 6 | 启动前置 | NC 端配合度评估 7 项需完成至少 5 项才能进 A2-2（OAuth2 真接通）；阻塞时 Day 1-X 专注 A2-5（独立可做）|

### 风险隔离策略

- A2-1 至 A2-4 强依赖 NC 端 — 若 18a A1 评估清单 7 项 NC 端无反馈 → A2-1/2/3/4 顺延 Sprint 19a，18b 转候选 B/C/G
- A2-5 独立可做 — Day 1 主代理优先跑（~1.3 PD），不受 NC 端阻塞
