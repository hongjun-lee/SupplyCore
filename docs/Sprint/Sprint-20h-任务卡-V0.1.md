# Sprint 20h 任务卡 V0.1（累计技术债清扫 · main 主轨化 / second 副轨 Reports 持续 / 35 Sprint 0 顺延目标）

**项目：** 阜矿物资供应管理系统 / SupplyCore
**版本：** V0.1（main a 起草 · 5 开放问题待 cici 答 / 基于 roadmap §2.3 候选）
**日期：** 2026-05-17
**文档性质：** 实施层 · Sprint 20h 提前规划任务卡（V0.1 起草框架 → cici 5 答 → V0.2 拍板启动 D1）
...
**main 主代理 a 签名**：2026-05-17 V0.1 起草（基于 roadmap §2.3 候选）· 等 cici 5 答 + 升 V0.2 启动
