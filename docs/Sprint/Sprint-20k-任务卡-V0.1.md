# Sprint 20k 任务卡 V0.1（第 3 周期开局 · 第 0 批上线准备 + 数据问题台账模块 / 38 Sprint 0 顺延目标）

**项目：** 阜矿物资供应管理系统 / SupplyCore
**版本：** V0.1（main a 起草 · 5 开放问题待 cici 答 / 按同事 273 行建议主轴）
**日期：** 2026-05-17
**文档性质：** 实施层 · Sprint 20k 提前规划任务卡（V0.1 起草 → cici 5 答 → V0.2 拍板启动 D1 / **第 3 周期第 1 Sprint / 上线 + 数据治理导向**）
**配套**：
...
- [`分批上线与基础数据采集计划-V0.1.md`](../上线/分批上线与基础数据采集计划-V0.1.md)（同事 273 行建议）
- [`数据采集总览-V0.1.md`](../上线/数据采集模板/00-数据采集总览-V0.1.md)（6 类模板）
- [`数据问题台账-详设-V0.1.md`](../详细设计/数据问题台账-详设-V0.1.md)
...
| **T-A2** 数据问题台账模块实施 | 0.6 | Entity + Manager + AppService + Controller + 单测 / 按 `数据问题台账-详设-V0.1.md` 详设 / commit `efd747f` | A 数据治理 |
...
**main 主代理 a 签名**：2026-05-17 V0.1 起草（战略转向 / 第 3 周期 / 上线 + 数据治理导向）· 等 cici 5 答 + 升 V0.2 启动
