...
| 编号 | 实体（中/英） | 关键字段 | 状态字段 | 备注 |
| --- | --- | --- | --- | --- |
| E-01 | 设备档案 equipment | equipment_id (PK), equipment_code, equipment_name, equipment_type, source_type, org_id (FK→M-01), warehouse_id (FK→M-02) | equipment_status: 可用/在用/租赁在用/维修中/停用/待报废/已报废；source_type: 采购入库/直达验收/外部购置/历史补录/租赁引入 | 跨域：可关联 S-05/S-03 来源 |
