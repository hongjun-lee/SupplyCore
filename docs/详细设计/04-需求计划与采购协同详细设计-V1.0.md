...
> **业务依据：** 流程调研业务方答复 Q-02-6（2026-05-09 软提示）+ Spencer 拍板（2026-05-09 V1.3 选方案 C 折中）+ 政策 04 第十九条（询比/竞价**硬性 ≥ 3 家**）。
...
- **监控**：详设 09 §六预警规则 ALR-PUR-001 在响应供应商 < 3 家时触发"重要"级提醒（无论是否走特批均触发）；月度报表 RPT-PUR-INSUFFICIENT 暴露不足比例（合规审计依据）。
