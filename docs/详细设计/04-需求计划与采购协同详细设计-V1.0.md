...
本文档承接 `01-数据库逻辑模型-V1.0.md` 跨模块骨架与 `02-基础档案与组织仓库详细设计-V1.0.md`、`03-物料主数据与编码详细设计-V1.0.md` 的底座，把需求计划与采购协同模块涉及的 20 个实体的全字段、状态机、业务规则、接口规范、配置项和占位项固化下来。
...
| `docs/详细设计/03-物料主数据与编码详细设计-V1.0.md` | M-05 material_state 约束（不允许待申请/待审核状态物料进入采购流程） |
