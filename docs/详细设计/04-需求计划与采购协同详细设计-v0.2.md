...
本文档承接 `01-数据库逻辑模型-v0.7.md` 跨模块骨架与 `02-基础档案与组织仓库详细设计-v0.6.md`、`03-物料主数据与编码详细设计-v0.2.md` 的底座，把需求计划与采购协同模块涉及的 20 个实体的全字段、状态机、业务规则、接口规范、配置项和占位项固化下来。
...
| `docs/详细设计/02-基础档案与组织仓库详细设计-v0.6.md` | SY-01 前缀清单、M-01/M-02/M-07/M-12/M-13 引用约定 |
