...
## 二、本版覆盖范围（v0.10 = v0.9 + 档 A 一期 Week 1 引擎层）
...
| 周 | 内容 | 状态 |
|---|---|---|
| **Week 1** | 框架层：store / sm / linkage / seed / nc / roles / ui | ✅ **完成**（5 天全交付）|
| Week 2 | 业务前段：需求 → 计划 → 任务 → 招采 | pending |
| Week 3 | 业务中段：合同 → 订单 → 验收 → 质检 | pending |
| Week 4 | 核心联动 + NC mock：S-05 库存原子事务 + F-01 推送 | pending |
| Week 5 | 一类扩展：审批中心 E1 + 预警中心 E2 | pending |
