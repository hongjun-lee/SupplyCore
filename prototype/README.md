...
### v0.16 档 A 一期同事评审 5 项 P1/P2 修复

档 A 一期 v0.15 收口后，同事评审发现 5 项联动断链 / 口径不一致问题，本版修复：
...
| **P2-2** | C-04 残留文案 | "付款节点（C-04）"、"修订 C-04 节点" 等 | contract-detail.html 改文案：付款节点 → 付款条件（payment_terms 文本字段）+ 标注"C-04 节点移二期 A4"；C-02 创建带 payment_terms 默认文本 |
...
### v0.15 档 A 一期 · Week 6 收口（核心报表 + 演示脚本 + 一期完成 ✅）
...
档 A 一期 Week 6 **完成 100%**。下一阶段：档 A 二期（按 03 V0.2，等业务方反馈触发，不主动推进）。
