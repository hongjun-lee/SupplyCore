...
SC.nav = [
  ...
  { title: '业务流转', items: [
    ...
    { id: 'inventory-transfer', href: 'inventory-transfer.html', label: '库存调拨 ★二期', icon: '⇄' },
    { id: 'outsourced-processing', href: 'outsourced-processing.html', label: '委托加工 ★二期', icon: '⊕' },
  ...
  { title: '采购协同', items: [
    ...
    { id: 'direct-delivery',   href: 'direct-delivery.html',    label: '直达使用 ★二期', icon: '⇩' },
    { id: 'emergency-purchase', href: 'emergency-purchase.html', label: '应急采购 ★二期', icon: '⚠' },
  ]},
  { title: '合同与资金', items: [
  ...
  { title: '基础数据', items: [
    ...
    { id: 'master-data-admin', href: 'master-data-admin.html',  label: '主数据维护 ★二期', icon: '▦' },
  ]},
  { title: '决策 / AI', items: [
    ...
    { id: 'demo-snapshot',     href: 'demo-snapshot.html',      label: '演示数据快照 ★二期', icon: '▢' },
  ...
  { title: '运维 / 集成', items: [
    ...
    { id: 'reconciliation',    href: 'reconciliation.html',     label: '三对一致对账（月度）★二期', icon: '↔' },
