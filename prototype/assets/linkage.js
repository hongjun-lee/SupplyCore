...
(function () {
  ...
  /* C-02 已签 → 同步设置 executed_amount = 0 / paid_amount = 0
     + 二阶段 A4a：自动按 payment_terms 拆 3 个 C-04 付款节点（30%预付 / 60%验收 / 10%质保），
  ...
  /* ========================================================
   * 二阶段 P0 引擎接入（v0.18 补 — 让二期页面也走引擎层）
   * ======================================================== */
  ...
  /* ========================================================
   * 二阶段 P1 引擎接入（v0.19 — A3 调拨 + A5 盘点 + A12 后评价 + B3 主数据）
   * ======================================================== */
  ...
  /* ========================================================
   * 二阶段 P2 引擎接入（v0.20 — A6 废旧 + A11 直达 + A13 应急）
   * ======================================================== */
  ...
  /* ========================================================
   * 二阶段 P2 第二批引擎接入（v0.21 — A7 + A9 + A10）
   * ======================================================== */
